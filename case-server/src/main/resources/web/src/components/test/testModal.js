        ...
        footer={
          <div>
            ...
            {titleModeTask === '新建测试任务' && (
              <Button
                onClick={() => this.props.saveGo(this.props.form)}
                type="primary"
              >
                保存继续添加
              </Button>
            ...
            <Fragment>
              <Form.Item {...formItemLayout} label="关联用例集">
                {getFieldDecorator('relation', {
                  ...
                  initialValue:
                    titleModeTask === '编辑测试任务' ? record.relation : [],
                })(
                  <Select
              ...
              <Form.Item {...formItemLayout} label="是否新建">
                {getFieldDecorator('create', {
                  initialValue:
                    titleModeTask === '编辑测试任务' ? record.create : true,
            ...
            <Fragment>
              <Form.Item {...formItemLayout} label="名称：">
                {getFieldDecorator('title', {
                  ...
                  initialValue:
                    titleModeTask === '编辑测试任务' ? record.title : '',
              ...
              <Form.Item {...formItemLayout} label="负责人">
                {getFieldDecorator('owner', {
                  // initialValue:
                  //   titleModeTask === '编辑测试任务' && record.owner
                  //     ? record.owner.split(',')
                  //     : [],
                  initialValue:
                    titleModeTask === '编辑测试任务' && record.owner
              ...
              <Form.Item {...formItemLayout} label="描述：">
                {getFieldDecorator('description', {
                  initialValue:
                    titleModeTask === '编辑测试任务' ? record.description : '',
                ...
                {getFieldDecorator('cyclePlan', {
                  ...
                  <RangePicker
                    ...
                    onChange={(value, dateString) =>
                      this.props.onDataChange(value, dateString)
                    }
                    style={{ width: '100%' }}
                  />,
                )}
                    ...
                    <Radio.Group onChange={e => this.props.radioOnChange(e)}>
                      <Radio style={radioStyle} value={'0'}>
                        ...
                        <p className="small-size-font">
                          {' '}
                          覆盖全部可用用例（共计 {caseInfo.totalCount ||
                            '0'}{' '}
                      ...
                      <Radio style={radioStyle} value={'1'}>
                        ...
                        <Row className="menu-case">
                          ...
                          <Col span={20}>
                            <Select
                              ...
                              placeholder="请选择标签"
                              onChange={e =>
                                this.props.handleChangeTagSelect(e)
                              }
                              value={resource}
                            >
                              {caseInfo.taglist &&
                                caseInfo.taglist.length > 0 &&
                                caseInfo.taglist.map((item, index) => (
                        ...
                        {radioValue === '1' &&
                          ...
                          (caseInfo.count || caseInfo.count === 0) && (
                            <span style={{ marginLeft: 22 }}>
                              {caseInfo.count}条用例集已选
                            </span>
                          )}
                      </Radio>
                    </Radio.Group>,
