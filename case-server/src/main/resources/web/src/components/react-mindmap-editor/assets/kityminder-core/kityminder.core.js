...
(function () {
  ...
  _p[42] = {
    value: function (require, exports, module) {
       ...
       *   -1: 其它情况
       */
      var ArrangeDownCommand = kity.createClass('ArrangeDownCommand', {
        base: Command,
        execute: function (km) {
          var nodes = km.getSelectedNodes();
          nodes.sort(desc);
      ...
      Module.register('ImageViewer', function () {
        ...
        var ImageViewer = kity.createClass('ImageViewer', {
          constructor: function () {
            ...
            var toolbar = (this.toolbar = createEl('div', 'km-image-viewer-toolbar', [
              btnSource,
              btnClose,
            ]));
